          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('About Roomie Radar', style: boldTextStyle()),
                  8.height,
                  Text(
                      'Roomie Radar is your go-to platform for finding the perfect house and housemates. Our app uses advanced AI technology to match you with compatible living spaces and like-minded roommates, making your rental experience smoother and more enjoyable.',
