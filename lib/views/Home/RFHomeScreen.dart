...
import 'package:roomie_radar/fragment/RFAccountFragment.dart';
import 'package:roomie_radar/fragment/RFHomeFragment.dart';
import 'package:roomie_radar/fragment/RFSettingsFragment.dart';
    ...
    return BottomNavigationBar(
      ...
      items: [
        _buildBottomNavigationBarItem(
          ...
          label: 'Home',
          activeIcon:
              const Icon(Icons.home_outlined, color: rfPrimaryColor, size: 22),
        ),
        _buildBottomNavigationBarItem(
